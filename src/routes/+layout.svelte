<script lang="ts">
	...
	const navItems: INavBar[] = [
		...
		{ label: 'Femme', link: '#' },
		{ label: 'Homme', link: '#' },
		{ label: 'Enfant & bébé', link: '#' },
		{ label: 'Equipements & loisirs', link: '#' },
		{ label: 'Nutrition & Santé', link: '#' },
		{ label: 'Seconde Vie', link: '#' },
		{ label: 'Soldes & Bons Plans', link: '#', highlight: true },
		{ label: 'Services et voyages', link: '#' }
	];
</script>
